...
export class TeacherController {
  ...
  getTeachers = async (req: Request, res: Response) => {
    ...
    this.teacherService.getTeachers(paginationDto!)
  ...
  createTeacher = (req: Request, res: Response) => {
    ...
    this.teacherService.createTeacher(createTeacherDto!, req.body.user)
  ...
  updateTeacher = (req: Request, res: Response) => {
    ...
    this.teacherService.updateTeacher(updateTeacherDto!, req.body.user, parseInt(req.params.id))
      .then(teacher => res.status(201).json(teacher))
      .catch(error => this.handleError(error, res));
  ...
  deleteTeacher = (req: Request, res: Response) => {
    ...
    this.teacherService.deleteTeacher(req.body.user, parseInt(req.params.id))
      .then(teacher => res.status(201).json(teacher))
      .catch(error => this.handleError(error, res));
